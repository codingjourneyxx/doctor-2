...
export const SidebarNavigationDualTier = ({ activeUrl, hideBorder, items, footerItems = [], featureCard }: SidebarNavigationDualTierProps) => {
    ...
    const secondarySidebar = (
        <div
            ...
            className={cx(
                "relative h-full overflow-x-hidden overflow-y-auto bg-primary transition-[width] duration-200 ease-out",
                !hideBorder && isSecondarySidebarVisible && "box-content border-r-[1.5px] border-secondary",
            )}
        >
